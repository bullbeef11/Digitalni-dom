        ...
        <div class="container">
          ...
          <div class="row footer-links clearfix">
            ...
            <div class="col-md-3">
              <div class="fl-1">
                <!-- Title -->
                <h6 class="d-title">Digitalni dom</h6>
                <h6 class="m-title">Digitalni dom</h6>
            ...
            <div class="col-md-5">
              <div class="fl-2">
                <!-- Title -->
                <h6 class="d-title">Naše usluge</h6>
                <h6 class="m-title">Naše usluge</h6>
            ...
            <div class="col-md-4">
              ...
              <div class="fl-5">
                ...
                <!-- Title -->
                <h6 class="d-title">Ostalo</h6>
                <h6 class="m-title">Ostalo</h6>
